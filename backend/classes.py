# Centralized 38 PlantVillage class definitions and human-readable display names
...
def get_display_name(class_name: str) -> str:
    """Returns human-readable display name for a given class name."""
    return DISPLAY_NAMES.get(class_name, class_name.replace("___", " - ").replace("_", " "))
